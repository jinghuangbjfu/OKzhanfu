$(function(){
	...
	$("#mapIcon").click(function(){
		var top=parseInt($(".map").offset().top);
...
document.write(unescape("%3Cscript src='" + _bdhmProtocol + "api.map.baidu.com/api?ak=ftTWWQVT5Bjj4ASIVjSHWFMw&v=2.0' type='text/javascript'%3E%3C/script%3E"));
...
var point = new BMap.Point(121.379688,31.23888);//定义一个中心点坐标1/坐标是多少，可以用百度提供的拾取坐标系统
...
//标注点数组
    var markerArr = [{title:"OK展服",content:"Tel：15901912807<br/>E-mail：chili@okzf.com<br/>",point:"121.379688|31.23888",isOpen:0,icon:{w:23,h:25,l:46,t:21,x:9,lb:12}}
];
//创建marker
function addMarker(){
